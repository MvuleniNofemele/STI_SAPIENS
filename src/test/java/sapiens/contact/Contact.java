        ...
        try {
            if (exists("labelPaymentMeansDetails", true, "Payment Means Details Exists")) {
                ...
                if (exists("bankAccountContainer", true, "Sapiens IDIT Dialog Box")) {
                    selectValueFromDropdown("drpDwnAccountType", "text","Current Account", "Select Account Type");//accountType
                    setText("txtBoxAccountHolderSurname", "ABSA test", "Enter Account Holder Surname");//surName
                    setText("txtBoxAccountHolderInitials","J", "Enter Account Holder Initials");//initials
